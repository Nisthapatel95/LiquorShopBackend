        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OcrScanId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PurchaseOrders_OcrScans_OcrScanId",
                        column: x => x.OcrScanId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrders_OcrScanId",
                table: "PurchaseOrders",
                column: "OcrScanId",
                unique: true,
                filter: "[OcrScanId] IS NOT NULL");
